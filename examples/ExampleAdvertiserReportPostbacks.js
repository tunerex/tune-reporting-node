...
var
  ...
  async = require('async'),
  AdvertiserReportPostbacks = tune_reporting.api.AdvertiserReportPostbacks,
...
try {
  ...
  async.series({
    startExample: function (next) {
      console.log('\n');
      console.log('======================================================');
      console.log(' Begin: Tune Management API Log Postbacks        ');
      console.log('======================================================');
      console.log('\n');
      next();
    },
    fields_recommended: function (next) {
      console.log('======================================================');
      console.log(' Fields of Log Postbacks.                        ');
      console.log('======================================================');
      console.log('\n');
    ...
    count: function (next) {
      ...
      console.log(' Count Log Postbacks.                                 '.blue.bold);
      console.log('======================================================'.blue.bold);
      console.log('\n');
    ...
    find: function (next) {
      console.log('\n');
      console.log('======================================================');
      console.log(' Find Log Postbacks.                            ');
      console.log('======================================================');
      console.log('\n');
    ...
    exportCsvReport: function (next) {
      console.log('\n');
      console.log('======================================================');
      console.log(' Export Log Postbacks CSV report.                            ');
      console.log('======================================================');
      console.log('\n');
      ...
      export_request.once('success', function (response) {
        if ((response.getHttpCode() !== 200) || (response.getErrors() !== null)) {
          ...
          csv_job_id = endpointAdvertiserReportPostbacks.parseResponseReportJobId(response);
    ...
    fetchCsvReport: function (next) {
      console.log('\n');
      console.log('======================================================');
      console.log(' Fetch Log Postbacks CSV report.                         ');
      console.log('======================================================');
      console.log('\n');
      var fetch_request = endpointAdvertiserReportPostbacks.fetchReport(
        csv_job_id,
        true        // verbose
      );
      ...
      fetch_request.once('success', function (response) {
        if ((response.getHttpCode() !== 200) || (response.getErrors() !== null)) {
          ...
          csv_report_url = endpointAdvertiserReportPostbacks.parseResponseReportUrl(response);
    ...
    exportJsonReport: function (next) {
      console.log('\n');
      console.log('======================================================');
      console.log(' Export Log Postbacks JSON report.                            ');
      console.log('======================================================');
      console.log('\n');
      var export_request = endpointAdvertiserReportPostbacks.exportReport(
        start_date,
      ...
      export_request.once('success', function (response) {
        if ((response.getHttpCode() !== 200) || (response.getErrors() !== null)) {
          ...
          json_job_id = endpointAdvertiserReportPostbacks.parseResponseReportJobId(response);
    ...
    fetchJsonReport: function (next) {
      console.log('\n');
      console.log('======================================================');
      console.log(' Fetch Log Postbacks JSON report.                         ');
      console.log('======================================================');
      console.log('\n');
      var fetch_request = endpointAdvertiserReportPostbacks.fetchReport(
        json_job_id,
      ...
      fetch_request.once('success', function (response) {
        if ((response.getHttpCode() !== 200) || (response.getErrors() !== null)) {
          ...
          json_report_url = endpointAdvertiserReportPostbacks.parseResponseReportUrl(response);
