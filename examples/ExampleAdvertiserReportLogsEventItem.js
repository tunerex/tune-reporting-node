...
try {
  ...
  async.series({
    taskStartExample: function (next) {
      ...
      console.log(' Begin: TUNE Advertiser Report Logs Event Item        '.blue.bold);
      console.log('======================================================'.blue.bold);
      console.log('\n');
      next();
    },
    taskDefine: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Define Metadata of Advertiser Report Logs Event Item.    ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskFieldsRecommended: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Recommended Fields of Advertiser Report Logs Event Item. ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskCount: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Count Advertiser Report Logs Event Item.                      ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskFind: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Find Advertiser Report Logs Event Item.                       ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskExportCsvReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Export Advertiser Report Logs Event Item CSV report.          ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskStatusCsvReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Status Advertiser Report Logs Event Item CSV report.          ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskFetchCsvReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Fetch Advertiser Report Logs Event Item CSV report.           ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskReadCsvReport: function (next) {
      ...
      console.log('\n');
      console.log('==========================================================');
      console.log(' Read Advertiser Report Logs Event Item CSV report.            ');
      console.log('==========================================================');
      console.log('\n');
      var
    ...
    taskExportJsonReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Export Advertiser Report Logs Event Item JSON report.    ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskStatusJsonReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Status Advertiser Report Logs Event Item JSON report.    ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskFetchJsonReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Fetch Advertiser Report Logs Event Item JSON report.           ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskReadJsonReport: function (next) {
      ...
      console.log('\n');
      console.log('==========================================================');
      console.log(' Read Advertiser Report Logs Event Item JSON report.           ');
      console.log('==========================================================');
      console.log('\n');
      var
