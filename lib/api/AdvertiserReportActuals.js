#!/usr/bin/env node
/**
 * Classes that define advertiser Tune Management API endpoints.
 *
...
var
  util = require('util'),
  ReportsActualsEndpointBase = require('../base/endpoints').ReportsActualsEndpointBase;
 ...
 * @constructor
 * @extends ReportsActualsEndpointBase
 *
...
util.inherits(AdvertiserReportActuals, ReportsActualsEndpointBase);
