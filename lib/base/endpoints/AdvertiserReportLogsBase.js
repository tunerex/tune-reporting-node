 ...
 * @uses Postback Logs
 *
 * @class AdvertiserReportLogsBase
 ...
 */
function AdvertiserReportLogsBase(
  controller,
  apiKey,
  filterDebugMode,
  filterTestProfileId,
  ...
  AdvertiserReportLogsBase.super_.call(
    this,
    controller,
    apiKey,
    filterDebugMode,
...
// superConstructor.
util.inherits(AdvertiserReportLogsBase, AdvertiserReportBase);
 ...
 */
AdvertiserReportLogsBase.prototype.count = function (
  startDate,
  endDate,
  filter,
  strResponseTimezone,
 ...
 * @uses TuneManagementResponse
 */
AdvertiserReportLogsBase.prototype.find = function (
  startDate,
  endDate,
  fields,
  filter,
 ...
 * @uses TuneManagementResponse
 */
AdvertiserReportLogsBase.prototype.exportReport = function (
  startDate,
  endDate,
  fields,
  filter,
 ...
 * @uses TuneManagementResponse
 */
AdvertiserReportLogsBase.prototype.statusReport = function (
  jobId,
  callback
) {
 ...
 * @uses TuneManagementResponse
 */
AdvertiserReportLogsBase.prototype.fetchReport = function (
  jobId,
  verbose,
  sleep,
  callback
...
module.exports = AdvertiserReportLogsBase;