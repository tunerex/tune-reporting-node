...
TuneManagementResponse.prototype.getData = function () {
  if (this.responseJson && this.responseJson.hasOwnProperty('data')) {
...
TuneManagementResponse.prototype.getResponseSize = function () {
  if (this.responseJson && this.responseJson.hasOwnProperty('response_size')) {
...
TuneManagementResponse.prototype.getStatusCode = function () {
  if (this.responseJson && this.responseJson.hasOwnProperty('status_code')) {
...
TuneManagementResponse.prototype.getErrors = function () {
  if (this.responseJson && this.responseJson.hasOwnProperty('errors')) {
...
TuneManagementResponse.prototype.getDebugs = function () {
  if (this.responseJson && this.responseJson.hasOwnProperty('debugs')) {
 ...
 * @return {JSON}
 */
TuneManagementResponse.prototype.toJson = function () {
