 ...
 * @final
  */
TuneManagementRequest.SDK_VERSION = '0.1.18';
...
TuneManagementRequest.prototype.getQueryStringBuilder = function () {
  ...
  qsb.add('sdk', TuneManagementRequest.SDK_NAME);
  qsb.add('ver', TuneManagementRequest.SDK_VERSION);

  if (this.authKey && this.authType) {
    qsb.add(this.authType, this.authKey);
  }
